...
namespace Assets.Scripts.Network
{
    ...
    public class SecondsRemainingUICommandsSender : ISecondsRemainingUICommandsSender
    {
        ...
        public SecondsRemainingUICommandsSender(IServerNetworkManager networkManager, IEveryBodyVsTheTeacherServer server)
        {
        ...
        {
            if (!this.server.ConnectedMainPlayersConnectionIds.Any() && 
                !this.paused && 

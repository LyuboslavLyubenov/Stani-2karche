...
namespace Reporter
{
    ...
    public class Reporter : MonoBehaviour
    {
        ...
        private void initializeStyle()
        {
            ...
            this.toolbarScrollerSkin = (GUISkin)GameObject.Instantiate(skin);
            ...
            this.logScrollerSkin = (GUISkin)GameObject.Instantiate(skin);
            ...
            this.graphScrollerSkin = (GUISkin)GameObject.Instantiate(skin);
        ...
        private void Start()
        {
            this.logDate = System.DateTime.Now.ToString();
        ...
        private void DrawInfo()
        {
            ...
            GUILayout.Space(this.size.x);
            GUILayout.Label(System.DateTime.Now.ToString(), this.nonStyle, GUILayout.Height(this.size.y));
        ...
        private void drawToolBar()
        {
            ...
            if (this.showClearOnNewSceneLoadedButton && GUILayout.Button(this.clearOnNewSceneContent, (this.clearOnNewSceneLoaded) ? this.buttonActiveStyle : this.barStyle, GUILayout.Width(this.size.x * 2), GUILayout.Height(this.size.y * 2))) {
        ...
        public void OnGUIDraw()
        {
            ...
            this.stackRect.y = Screen.height * 0.75f;
            ...
            this.detailRect.y = Screen.height - this.size.y * 3;
	...
	float lastUpdate2 = 0;
        ...
        private void Update()
        {
            ...
            this.gcTotalMemory = (((float)System.GC.GetTotalMemory(false)) / 1024 / 1024);
            //addSample();

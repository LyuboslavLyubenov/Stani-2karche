...
namespace Assets.Tests.UI.Jokers.MainPlayer.Election
{
    ...
    public class WhenClickedThumbsDownSendVotedAgainstJokerCommand : ExtendedMonoBehaviour
    {
        [Inject]
        private IClientNetworkManager networkManager;

        [Inject(Id = "ThumbsDownButton")]
                                    ...
                                    dummyNetworkManager.OnSentToServerMessage += (sender, args) =>
                                        {
                                            ...
                                            if (command.Name == "PlayerVotedAgainst")
                                            {
                                                IntegrationTest.Pass();
                                            }
                                        };
                                    this.thumbsDownButton.SimulateClick();
                                });
                    });
        }
    }

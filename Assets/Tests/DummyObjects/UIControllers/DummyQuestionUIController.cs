namespace Assets.Tests.DummyObjects.UIControllers
{
    ...
    public class DummyQuestionUIController : IQuestionUIController
    {
        ...
        protected Dictionary<string, int> answersVotes = new Dictionary<string, int>();
        ...
        public DummyQuestionUIController()
        {
